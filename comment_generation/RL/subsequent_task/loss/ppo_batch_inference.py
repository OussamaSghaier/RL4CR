batch_idx = 3
# python ppo_batch_inference.py --test_data ../SFT/hf-datasets/test/ --save_steps 20 --batch_size 2 --continue_from_checkpoint
import os
...
def run_inference(model_name, dataset, batch_size=10,  save_steps=100, continue_from_checkpoint=False, save_file=f'hf-datasets/inference_results/inference_results_ckpt_44000-batch_{batch_idx}.pkl'):
...
if __name__ == "__main__":
    ...
    model_name = 'output_ppo/final_ppo_model/'
    ...
    print(f'*** Processing batch {batch_idx} from {start_idx} to {end_idx} ***')
    ...
    dataset.save_to_disk(f'hf-datasets/inference_results/ppo-inference-ckpt_44000-batch_{batch_idx}')
