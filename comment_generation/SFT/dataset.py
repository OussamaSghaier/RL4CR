...
class CodeReviewDataset(Dataset):
    def __init__(self, file_path):
        ...
        self.data = [{  'code_diff': d['patch'][:min(750, len(d['patch']))],
                        'comment': d['msg']} for d in self.data]
...
if __name__ == "__main__":
    save_dataset_to_disk('../data/comment_generation/msg-train.jsonl', 'hf-datasets/train')
    save_dataset_to_disk('../data/comment_generation/msg-test.jsonl', 'hf-datasets/test')
